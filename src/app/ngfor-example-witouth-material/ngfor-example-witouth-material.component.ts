...
@Component({
  selector: 'app-ngfor-example-witouth-material',
  templateUrl: './ngfor-example-witouth-material.component.html',
  styleUrls: ['./ngfor-example-witouth-material.component.css']
})
export class NgforExampleWitouthMaterialComponent {

  headers = ["id_producto","nombre","id_categoria","codigo_barras","precio_venta","cantidad_stock","estado"]
  rows =  [
